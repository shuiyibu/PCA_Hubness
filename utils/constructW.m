function [W,k_ocurrence] = constructW(fea,options)
%	Usage:
    ...
    if ~(bCosine && options.bNormalized)
        ...
        for i = 1:ceil(nSmp/BlockSize)
            if i == ceil(nSmp/BlockSize)
                ...
                csvwrite('/Users/langdylan/Downloads/dist.csv',dist);
                ...
                if bSpeed
                    ...
                    for j = 1:options.k+1
                        ...
                        if j>1
                            for m=1:nSmpNow 
                                k_ocurrence(idx(m,j))=k_ocurrence(idx(m,j))+1;
                            end
                        end
